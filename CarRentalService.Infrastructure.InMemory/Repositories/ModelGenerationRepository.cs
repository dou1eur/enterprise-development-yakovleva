...
/// </summary>
public class ModelGenerationRepository : BaseRepository<ModelGeneration, Guid>, IModelGenerationRepository
{
    /// <summary>
    ...
    protected override object? GetId(ModelGeneration entity) => entity.Id;
    ...
    {
        var generations = _entities.Where(g => g.VehicleModelId == modelId).ToList();
